    ...
    for i in cc_sizes.keys():
        ...
        try:
            ...
            if 1.5 <= (max_x - min_x)/(max_y - min_y) <= 5.0:
                # Return the coordinates of the corners of the connected component to the dictionary
...
def main():
    ...
    filtered_image = computeStandardDeviationImage5x5(contrast_stretched_pixel_array1, image_width, image_height)
    contrast_stretched_pixel_array2 = scaleTo0And255AndQuantize(filtered_image, image_width, image_height)
